...
int main_(int argc, char* argv[])
{
    ...
    oJson1.AddEmptySubObject("depend");
	oJson1["depend"].Add("nebula", "https://github.com/Bwar/Nebula");
	oJson1["depend"].AddEmptySubObject("bootstrap");
	oJson1["depend"]["bootstrap"].Add("BEACON", "as");
	oJson1["depend"]["bootstrap"]["BEACON"].Add("asas");
	oJson1["depend"]["bootstrap"].Add("LOGIC");
	oJson1["depend"]["bootstrap"].Add("LOGGER");
	oJson1["depend"]["bootstrap"].Add("INTERFACE");
	oJson1["depend"]["bootstrap"].Add("ACCESS");
	oJson1["depend"]["bootstrap"].Add(121);
    std::cout << oJson1.ToString() << oJson1["depend"]["bootstrap"].GetArraySize()<< std::endl;
//return 0;
